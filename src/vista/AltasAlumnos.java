        ...
        if(e.getSource()==btnAgregar) {
            if((comboCarrera.getSelectedItem().equals("Selecciona opcion...")) || comboSemestre.getSelectedItem().equals("Selecciona una opcion")) {
                ...
                if(validarCajas()) {
                    ...
                    boolean registro=aDAO.agregarAlumno(alumno);
                    System.out.println(registro?"Exito":"Se cambio de carrera");
                    actualizarTabla();
                }else {
